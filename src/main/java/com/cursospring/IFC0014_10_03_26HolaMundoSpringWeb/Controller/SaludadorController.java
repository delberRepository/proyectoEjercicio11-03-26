...
import com.cursospring.IFC0014_10_03_26HolaMundoSpringWeb.Service.SaludadorServicio;
...
import java.util.List;
  ...
  public class SaludadorController {
    ...
    @Autowired
    private  SaludadorServicio saludadorServicio;


    @PostMapping
    public List<Saludo> obtenerSaludos(@RequestBody String nombre) {
      return saludadorServicio.getSaludos(nombre);
    }
